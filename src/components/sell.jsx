      ...
      <div className="pt-[120px] lg:absolute lg:left-[35%] lg:top-[12%] lg:w-[60%]">
          ...
          <div className="flex flex-col items-center">
            <form
              ...
              className="w-[90%] bg-[#93407d] mb-[2rem] rounded-[10px] flex flex-col px-[1rem] pb-[2.5rem]"
            >
               <div
                onClick={() => {
              ...
              <input
                ...
                className="text-center bg-[#c397ba] text-black mt-[2rem] border py-[0.5rem] rounded-[10px] items-center"
              />
            </form>
          </div>
        </div>
