...
import bag1 from "../assets/tshmain.webp";
...
//   }, [index, images.length]);
  ...
  return (
    <div className="lg:absolute lg:left-[35%] lg:top-[12%] lg:w-[60%]">
      <div className="relative text-left pt-[10%] lg:pt-[8%] lg:top-[25%]">
        <img src={images[index]} alt="Cadmus" className=" w-[100%] "/>
        <div className="flex flex-col items-center justify-center w-[100vw] lg:w-[60vw] h-[92.5%] absolute top-[10%] mt-[-1.3rem] overLanding">
        </div>
      </div>
      <Search />
      <div className="flex justify-between p-2 px-[1.5rem] mb-[1rem] text-[#ffffff] bg-[#93407d] font-bold rounded-[20px] heading">
